...
class ComplianceAnalysisService:
    ...
    def _load_compliance_mapping(self) -> Dict[str, Any]:
        ...
        try:
            # Path is relative to backend folder: backend/configs/compliance_mapping.json
            config_path = Path(__file__).parent.parent.parent / "configs" / "compliance_mapping.json"
