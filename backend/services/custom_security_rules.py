...
from .rule_engine import CustomRule, AllowedRuleType, SeverityLevel, AllowedLanguage
from .rule_security import SecureRuleValidator
...
class CustomSecurityRulesEngine:
    ...
    def __init__(self, rules_directory: str = "custom_rules"):
