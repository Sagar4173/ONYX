...
export const EmailVerification = ({ token, onSuccess, onError }) => {
  ...
  const loadingView = (
    ...
    >
      ...
      <div className="relative">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-cyan-500 to-violet-600 rounded-2xl mb-4">
    ...
    >
      ...
      <div className="relative">
        <motion.div
          ...
          className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl mb-4 animate-bounce"
        >
        ...
        >
          <button
            onClick={onSuccess}
            className="w-full py-3 px-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-medium rounded-xl hover:from-green-600 hover:to-emerald-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-green-500/25"
          >
            Continue to Login
          </button>
        </motion.div>
  ...
  // Error State — sub-views
  const alreadyVerifiedView = (
    <motion.div
    ...
    >
      ...
      <div className="relative">
        ...
        <p className="text-gray-400 mb-6">
          Your email <span className="text-white font-medium">{email}</span> is already
          verified. You can log in to your account now.
        </p>
        <button
          onClick={onError}
          className="w-full py-3 px-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-medium rounded-xl hover:from-green-600 hover:to-emerald-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-green-500/25"
  ...
  const errorView = (
    ...
    >
      ...
      <div className="relative">
        ...
        {resendSuccess ? (
          ...
          <>
            ...
            <button
              ...
              className={`w-full py-3 px-4 font-medium rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 transition-all duration-300 shadow-lg flex items-center justify-center
                ${
                  isResending || !email
                    ? "bg-gray-600 text-gray-400 cursor-not-allowed"
                    : "rounded-full bg-gradient-to-r from-cyan-400 via-violet-500 to-cyan-400 text-white font-semibold hover:from-cyan-300 hover:via-violet-400 hover:to-cyan-300 shadow-lg hover:shadow-xl hover:shadow-cyan-500/20 transition-all duration-200 transform hover:scale-105"
                }`}
            >
              {isResending ? (
                <>
        ...
        <button
          onClick={onError}
          className="mt-4 text-gray-400 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 transition-colors duration-300 text-sm"
        >
          Return to Login
        </button>
      </div>
  ...
  return (
    <AnimatePresence mode="wait">
      {isVerifying ? loadingView : verificationStatus === "success" ? successView : alreadyVerified ? alreadyVerifiedView : verificationStatus === "error" ? errorView : null}
    </AnimatePresence>
  );
};
