        ...
        <div className="relative border-b border-gray-700/50 bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur-sm">
          <div className="p-6 pb-4">
            <div className="flex items-start justify-between">
              ...
              <button onClick={handleClose} aria-label="Close profile" className="p-2.5 hover:bg-red-500/10 hover:border-red-500/30 border border-transparent rounded-xl transition-all duration-300 group">
