/**
 * Data Policy Page - ONYX Security Platform
 * Professional data handling policy with real content
 */
  ...
  const sections = [
    {
      ...
      content: `ONYX Security Intelligence ("ONYX," "we," "us," or "our") is committed to protecting your data. This Policy explains how we collect, use, disclose, and safeguard your information when you use our security scanning platform and related services.

By accessing or using ONYX, you agree to this Policy. If you do not agree with the terms of this Policy, please do not access the platform.`,
    },
    {
      id: "data-collection",
...
To exercise these rights, contact us at legal@onyx-security.io or through your account settings.`,
    },
    {
      id: "international",
...
• **Compliance Frameworks**: Compliance with applicable frameworks
• **Data Processing Agreements**: Binding agreements with all processors
• **Adequacy Decisions**: Transfers to countries with adequate protection

We comply with GDPR, CCPA, and other applicable data regulations.`,
    },
  ];
