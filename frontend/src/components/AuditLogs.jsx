          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-xl">
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  type="text"
                  placeholder="Search logs by description, user, or IP..."
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-purple-500/20 hover:bg-purple-500/30 border border-purple-500/30 rounded-xl text-purple-300 transition-all"
              >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-xl text-blue-300 transition-all"
                >
