      ...
      <div className="mt-4 pt-4 border-t border-gray-700/50 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full px-3 lg:px-4 py-2 bg-gray-800 border border-gray-600/50 rounded-xl text-sm text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
            size="5"
          >
            {eventTypes.map((type) => (
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-2 bg-gray-800 border border-gray-700/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
            size="5"
          >
