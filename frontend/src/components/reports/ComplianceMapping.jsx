    ...
    <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-2">
            {Object.keys(COMPLIANCE_STANDARDS).map((std) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 ${
      ...
      <div id="compliance-section">
        {selectedStandards.map((standardKey) => {
          ...
          const compliantCategories = Object.values(categoryCompliance).filter(
            (c) => c.compliant
          ).length;
              ...
              <div
                className={`p-6 border-b border-gray-700/50 bg-gradient-to-r ${
                  standardKey === "OWASP"
                    ...
                    : standardKey === "NIST"
                      ? "from-cyan-900/30 to-violet-900/30"
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  <div className="flex justify-between mt-2 text-xs text-gray-500">
                    <span>
                      {compliantCategories}/{totalCategories} Controls Compliant
                    </span>
        ...
        <div className="space-y-3">
          {[
            ...
            return (
              <div
                key={idx}
                className={`flex items-start gap-3 p-3 rounded-lg ${cc.bg} border ${cc.border}`}
              >
                <span
                  className={`flex-shrink-0 px-2 py-0.5 rounded text-xs font-semibold ${cc.badge}`}
                >
                  {rec.priority}
                </span>
